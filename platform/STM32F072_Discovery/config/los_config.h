...
/* Reference ram size level 
    RAM_SIZE_LEVEL_0 means kernel ram < 8k  , 
    RAM_SIZE_LEVEL_1 means kernel ram < 16k, 
    RAM_SIZE_LEVEL_2 means means kernel ram>=32k 
	
	TODO: Remove this definition, leave full control and responbility to the user.
	Just make some suggestion based on the automatic detected RAM size.
*/	
#define	RAM_SIZE_LEVEL_1
	
//Current Verbose Level
#define VERBOSE_LEVEL VERBOSE_QUIET_LEVEL
 ...
 * Minimum stack size.
 */
#define LOS_TASK_MIN_STACK_SIZE                         (ALIGN(0x200, 16))
